               ...
               <section id='section1'>
                  <div className='container'>
                    <div className="title" style={{textAlign:'center'}}>
                        ...
                        <button onClick={()=>{this.setState({cnt: cnt+1})}} style={{cursor:'pointer',fontSize:'20px',backgroundColor:'#222',color:'#fff',padding:'10px 30px'}}>1씩증가</button>&nbsp;
                        <button onClick={()=>{this.setState({cnt: cnt+1})}} style={{cursor:'pointer',fontSize:'20px',backgroundColor:'#222',color:'#fff',padding:'10px 30px'}}>1씩감소</button>
                    </div>  
